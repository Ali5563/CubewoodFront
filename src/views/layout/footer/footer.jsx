        ...
        <div className="footer_bottom">
          <div className="row">
            <div className="col-md-2">
              <h5>Company Info</h5>
              <div className="company_info group_link">
                <Link>About Us</Link>
                <Link>Carrier</Link>
            ...
            <div className="col-md-2">
              <h5>Legal</h5>
              <div className="legal group_link">
                <Link>About Us</Link>
                <Link>Carrier</Link>
                <Link>We are hiring</Link>
                <Link>Blog</Link>
            ...
            <div className="col-md-2">
              <h5>Features</h5>
              <div className="features group_link">
            ...
            <div className="col-md-2">
              <h5>Resources</h5>
              <div className="resources group_link">
            ...
            <div className="col-md-4">
              ...
              <div className="description">Lore imp sum dolor Amit</div>
            </div>
          </div>
        </div>
      </div>
